...
class _ExChangeRateService implements ExChangeRateService {
  ...
  Future<ExChangeRateModel> fetchExChangeRate() async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ExChangeRateModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/2b4e139278f524ff1e41891c/latest/USD',
    ...
    final value = ExChangeRateModel.fromJson(_result.data!);
    return value;
  }
